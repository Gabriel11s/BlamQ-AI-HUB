        ...
        <TabsContent value="prompt">
          <div className="grid gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <Textarea value={config.conversation_examples || ""} onChange={(e) => updateConfig("conversation_examples", e.target.value)} placeholder={"Exemplo:\nLEAD: oi, vi o anuncio\nAGENTE: Oi! Que bom que entrou em contato. Me conta, o que te chamou atenção?\nLEAD: quero saber mais sobre o seguro\nAGENTE: Claro! Pra eu te indicar o melhor plano, me conta: quantos anos você tem?\n..."} rows={6} />
              </CardContent>
            </Card>
